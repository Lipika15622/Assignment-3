            ...
            <div class="mx-auto max-w-xl">
                <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
                    ...
                    <div class="mt-10 mx-auto w-full max-w-xl">
                        <form class="space-y-6" action="#" method="POST" enctype="maltipart/form" autocomplete="off">
                            <div>
                            ...
                            <div>
                                ...
                                <?php if (isset($errors['confirm_password'])) : ?>
                                    <p class="text-xs text-red-600 mt-2" id="password-error"><?= $errors['confirm_password']; ?></p>
                                <?php endif; ?>
                            </div>
